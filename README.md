## soem (melodic) - 1.4.1003-1

The packages in the `soem` repository were released into the `melodic` distro by running `/usr/bin/bloom-release soem --rosdistro melodic` on `Mon, 03 Aug 2020 19:15:55 -0000`
...
- rosdistro version: `1.4.1002-1`
- old version: `1.4.1002-1`
- new version: `1.4.1003-1`
...
## soem (melodic) - 1.4.1002-1

The packages in the `soem` repository were released into the `melodic` distro by running `/usr/bin/bloom-release soem --rosdistro melodic --track melodic --edit-track` on `Wed, 24 Jun 2020 06:35:20 -0000`
...
- old version: `1.4.1001-1`
- new version: `1.4.1002-1`
...
## soem (noetic) - 1.4.1002-1

The packages in the `soem` repository were released into the `noetic` distro by running `/usr/bin/bloom-release soem --rosdistro noetic` on `Wed, 24 Jun 2020 06:24:28 -0000`
...
## soem (noetic) - 1.4.1001-1

The packages in the `soem` repository were released into the `noetic` distro by running `/usr/bin/bloom-release soem --rosdistro noetic --new-track` on `Fri, 19 Jun 2020 19:49:42 -0000`
...
## soem (melodic) - 1.4.1001-1

The packages in the `soem` repository were released into the `melodic` distro by running `/usr/bin/bloom-release soem --rosdistro melodic` on `Fri, 19 Jun 2020 19:43:06 -0000`
